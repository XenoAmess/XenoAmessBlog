...
### 6. HackThebox Challenge 【ScriptKiddie】 再次努力了，再次没打掉
...
```shell
hydra -L /home/kali/Downloads/usernames.txt -P /usr/share/wordlists/rockyou.txt 10.129.123.6 -t 4 ssh
```
...
### 7. HackThebox Challenge 【Under Construction】 再次努力了，再次没打掉
